console.log("🔥 VERSION 28 - STABLE FORMULA + DATE FIX 🔥");
...
// ✅ FIXED: safe string (no template literal break)
...
function toExcelDate(value) {
  ...
  return d; // ExcelJS needs Date object
}
