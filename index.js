console.log("🔥 VERSION 29 - STABLE + ALIGNMENT FIX 🔥");
...
// ✅ SAFE formula builder (NO template literals)
...
function copyTemplateRowStyle(templateRow, targetRow) {
  templateRow.eachCell({ includeEmpty: true }, (cell, colNumber) => {
    ...
    // ✅ FORCE horizontal center alignment
...
function setFormulaCell(cell, formula, result) {
  ...
  // keep alignment even for formula cells
  cell.alignment = {
    horizontal: "center",
    vertical: "middle",
  };
...
app.post("/export", async (req, res) => {
  try {
    ...
    // ✅ SAFE HEADER (NO template string = no crash)
    res.setHeader(
      "Content-Disposition",
